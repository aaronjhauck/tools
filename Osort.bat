...
@final = (
    "wac\\x64\\*\\x-none\\onenote\\client\\errorhandling\\onenoteexceptioncatcher.js {en-us}",
    "wac\\x64\\*\\x-none\\onenote\\client\\objectmodel.js {x-none en-us}"
);
